...
let sharedModelContainer: ModelContainer = {
    let schema = Schema([LogEntry.self, ChecklistRecord.self, KnowledgeCard.self, KnowledgeProgress.self, KnowledgeRecentlyShown.self, ChecklistItem.self, ChecklistPunch.self, DriveRoute.self, UserProfile.self, DrivingRule.self])
